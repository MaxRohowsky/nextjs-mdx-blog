...
Set Goals. A boat that sets sail without a destination drifts in the direction of the wind. Similar to a boat, our lives are affected by external forces that push us in different directions. Often, these forces are devious because they like to hide:
...
Keep It Simple. It’s not easy to distill things down to their core and explain them in a simple manner. Often, you’ll find that people who explain things in a bloated and complicated way, don’t have a solid understanding themselves.
...
Here’s an excellent example of Richard Feynman explaining quantum mechanics in a simple way. ↩︎
James Somers goes into more detail on working quick in his blog post. ↩︎