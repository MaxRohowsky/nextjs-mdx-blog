...
const initialTodos = [
  ...
  { id: 34, text: 'Handle space between elements on landingpage with spacer component: https://seya01.medium.com/how-to-style-margin-with-react-d250d512d0a0.', completed: false, priority: 1 },
  { id: 35, text: 'Link up the stuff under popular content.', completed: true, priority: 2 },
  { id: 36, text: 'Filter on the right not left (see projects).', completed: false, priority: 2 },
