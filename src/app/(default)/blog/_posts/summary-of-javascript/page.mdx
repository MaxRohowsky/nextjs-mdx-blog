...
Statement: JavaScript code is just a sequence of statements that are separated by semicolons. By default, statements are executed in the order they are written
...
let y = 10;
const x, y, z;
Object: In JS, objects belong to the list of primitive values. And they store a collection of properties and values. For example, the
