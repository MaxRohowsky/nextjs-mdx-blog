...
const initialTodos = [
  ...
  { id: 13, text: 'Touch grass.', completed: true, priority: 3 },
  ...
  { id: 23, text: 'Add the page not found page.', completed: true, priority: 2 },
  ...
  { id: 26, text: 'Add a sitemap.', completed: true, priority: 2 },
  ...
  { id: 43, text: 'Add Not found page', completed: true, priority: 2 },
  ...
  { id: 51, text: 'Fix "jumping" date formats in posts', completed: true, priority: 1 }, 
